...
This project is a Python-based lead generation and CRM integration tool I built during my internship at Alibaba.com with the help of AI. The language used is Indonesian.

## What it does
- Scrapes and structures lead data
- Cleans and standardizes records
- Prepares leads for CRM upload
- Reduces manual prospecting work

## Impact
- Improved team efficiency by approximately 200%
- Reduced repetitive administrative work
- Helped support a more targeted sales pipeline
